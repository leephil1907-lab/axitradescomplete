...
export default function SwapModal({
  ...
  const getUsdPrice = (code: string): number => {
    ...
    // Fallbacks
    switch (code) {
      case 'EUR': return quotes['EURUSD']?.price || 1.0845;
      case 'GBP': return quotes['GBPUSD']?.price || 1.2684;
      case 'BTC': return quotes['BTCUSD']?.price || 67845.00;
      case 'ETH': return quotes['ETHUSD']?.price || 3482.50;
      case 'SOL': return quotes['SOLUSD']?.price || 182.40;
      case 'XRP': return quotes['XRPUSD']?.price || 0.624;
      case 'XAU': return quotes['XAUUSD']?.price || 2342.80;
      case 'AAPL': return quotes['AAPL']?.price || 172.62;
      case 'NVDA': return quotes['NVDA']?.price || 881.86;
      case 'TSLA': return quotes['TSLA']?.price || 171.05;
      default: return 1.0;
    }
  };

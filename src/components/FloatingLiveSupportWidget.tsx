...
import { MessageSquare, X, Send, Bot, User, CheckCheck, Minimize2, Sparkles, Headset, ShieldCheck, ExternalLink, Mic, MicOff, Star, UserCheck, RefreshCw } from 'lucide-react';
...
const AXI_AVATAR = "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=120&auto=format&fit=crop&q=80";
              ...
              <div className="flex items-center gap-3">
                <div className="relative shrink-0">
                  <img
                    src={AXI_AVATAR}
                    alt="Axi Logo"
                    className="w-10 h-10 rounded-xl object-cover border border-emerald-500/50 shadow-md"
                  />

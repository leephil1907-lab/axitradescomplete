...
export default function AccountsView({ showToast, openSignUp, signUpStep, setSignUpStep, setView }: AccountsViewProps) {
            ...
            {wizardStep === 16 && generatedAccount && (
              ...
              >
                ...
                <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 p-3.5 rounded-xl text-[10px] font-bold text-slate-500 text-left max-w-md mb-6">
                  ...
                  <span>These credentials represent real STP broker connection layers. Use your terminals to log in or practice trades directly using the demo portfolios.</span>
                </div>
